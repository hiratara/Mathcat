...
# TEST 1: source and target
{
    my $morph = $BI->new( 
        ...
        morphism2 => Math::Category::Impl::SubroutineMorphism->new_with_sub(
            sub { return $_[0] + 10 },
        ), 
    );
    # Check the source.
    ...
    is $morph->source->morphism2->subroutine->(20), 20;  # id

    # Check the target.
    is $morph->target->morphism1->source_object,  '2';
    is $morph->target->morphism1->target_object,  '2';
    is $morph->target->morphism2->subroutine->(30), 30;  # id
}
...
{
    my $morph1 = $BI->new( 
        morphism1 => Math::Category::Impl::SubroutineMorphism->new_with_sub(
            sub { return $_[0] + 10 },
        ), 
    ...
    is $morph3->morphism1->subroutine->(1), '1111';
